...
export const FURNITURE_CATALOG: CatalogEntryWithCategory[] = [
  // ── Sprites start as hand-drawn, replaced by LimeZu when loaded ──
  { type: FurnitureType.DESK,       label: 'Desk',       footprintW: 2, footprintH: 1, sprite: DESK_SQUARE_SPRITE,  isDesk: true,  category: 'desks' },
  ...
  { type: FurnitureType.WHITEBOARD, label: 'Whiteboard', footprintW: 2, footprintH: 1, sprite: WHITEBOARD_SPRITE,   isDesk: false, category: 'wall' },
  { type: FurnitureType.CHAIR,      label: 'Chair',      footprintW: 1, footprintH: 1, sprite: CHAIR_SPRITE,        isDesk: false, category: 'chairs' },
  { type: FurnitureType.PC,         label: 'Monitor',    footprintW: 1, footprintH: 1, sprite: PC_SPRITE,           isDesk: false, category: 'electronics', canPlaceOnSurfaces: true },
  ...
  { type: FurnitureType.COUCH,      label: 'Couch',      footprintW: 2, footprintH: 1, sprite: COUCH_SPRITE,        isDesk: false, category: 'misc' },
  ...
  // ── New LimeZu furniture (sprites set to placeholder, replaced on load) ──
  { type: FurnitureType.MONITOR,    label: 'Monitor',    footprintW: 1, footprintH: 1, sprite: PC_SPRITE,           isDesk: false, category: 'electronics', canPlaceOnSurfaces: true },
  { type: FurnitureType.LAPTOP,     label: 'Laptop',     footprintW: 1, footprintH: 1, sprite: PC_SPRITE,           isDesk: false, category: 'electronics', canPlaceOnSurfaces: true },
  { type: FurnitureType.EXEC_CHAIR, label: 'Exec Chair', footprintW: 1, footprintH: 1, sprite: CHAIR_SPRITE,        isDesk: false, category: 'chairs' },
  { type: FurnitureType.VENDING_MACHINE, label: 'Vending Machine', footprintW: 1, footprintH: 2, sprite: COOLER_SPRITE, isDesk: false, category: 'misc' },
  { type: FurnitureType.AC_UNIT,    label: 'AC Unit',    footprintW: 1, footprintH: 1, sprite: COOLER_SPRITE,       isDesk: false, category: 'wall', canPlaceOnWalls: true },
  { type: FurnitureType.WALL_ART,   label: 'Wall Art',   footprintW: 1, footprintH: 1, sprite: LAMP_SPRITE,         isDesk: false, category: 'wall', canPlaceOnWalls: true },
  { type: FurnitureType.COPIER,     label: 'Copier',     footprintW: 1, footprintH: 1, sprite: FILING_CABINET_SPRITE, isDesk: false, category: 'electronics' },
